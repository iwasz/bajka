...
public:
        ...
        TreeModel (): owner (0), ownerForParent (0) {}
        virtual ~TreeModel () {}
...
/*------owner / controller / widget-----------------------------------------*/
        ...
        /// Zwraca obiekt ownera, czyli kontroler, lub widget, który zawiera ten model.
        ModelOwnerType getOwnerForParent () { return ownerForParent; }
        /// Zwraca obiekt ownera, czyli kontroler, lub widget, który zawiera ten model.
        ModelOwnerConstType getOwnerForParent () const { return ownerForParent; }
        /// Ustawia obiekt ownera, czyli kontroler, lub widget, który zawiera ten model.
        void setOwnerForParent (ModelOwnerType o) { ownerForParent = o; }

private:

        ModelOwnerType owner;
        ModelOwnerType ownerForParent;
