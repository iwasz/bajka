...
public:
        ...
        /**
         * Resetuje jedyny bufor z płynem i ustawia tak samo jak SPH_Setup m_Param,
         * m_Toggle i m_Vec.
         */
        ...
        /**
         * Ustawia początkowe wartości parametrów w m_Param i w m_Toggle.
         * Wylicza też wartości dla m_R2, m_Poly6Kern, m_LapKern, m_SpikyKern.
         */
        void SPH_Setup ();
